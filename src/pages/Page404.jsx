    ...
    return (
        <div className={'font-bold text-blue-800 text-4xl text-center flex items-center justify-center h-[100vh] flex-col'}>
            <svg width="100px" height="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10 10.5C10 11.3284 9.55228 12 9 12C8.44772 12 8 11.3284 8 10.5C8 9.67157 8.44772 9 9 9C9.55228 9 10 9.67157 10 10.5Z" fill="#1C274C"/>
            </svg>
            Page not found
        </div>
    );
